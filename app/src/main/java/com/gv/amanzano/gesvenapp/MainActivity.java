...
import com.gv.amanzano.user.UserListActivity;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_usuario) {
            Intent userActivity = new Intent(MainActivity.this, UserListActivity.class);
            startActivity(userActivity);
        } else if (id == R.id.nav_cliente) {

        } else if (id == R.id.nav_cat_producto) {
        ...
        } else if (id == R.id.nav_umedida) {

        } else if (id == R.id.nav_tipoventa) {
